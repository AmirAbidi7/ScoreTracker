 ...
 * @since 4.0.0
 */
export const isBroadcast = self => getBytes(self).every(byte => byte === 0xff);
/**
 ...
 * @since 4.0.0
 */
export const toCanonical = self => isIpv6Address(self) ? Option.getOrElse(fromIpv4Mapped(self), () => self) : self;
const InetV4Proto = {
  _tag: "InetAddressV4",
  [TypeId]: TypeId,
  [Equal.symbol](that) {
