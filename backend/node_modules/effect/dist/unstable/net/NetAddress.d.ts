 ...
 * @since 4.0.0
 */
export declare const isMacBroadcast: (self: MacAddress) => boolean;
/**
 ...
 * @since 4.0.0
 */
export declare const isMacMulticast: (self: MacAddress) => boolean;
/**
 ...
 * @since 4.0.0
 */
export declare const isMacUnicast: (self: MacAddress) => boolean;
/**
 ...
 * @since 4.0.0
 */
export declare const isMacLocallyAdministered: (self: MacAddress) => boolean;
/**
 ...
 * @since 4.0.0
 */
export declare const isMacUniversallyAdministered: (self: MacAddress) => boolean;
/**
 ...
 * @since 4.0.0
 */
export declare const isUnspecified: (self: IpAddress) => boolean;
/**
 ...
 * @since 4.0.0
 */
export declare const isLoopback: (self: IpAddress) => boolean;
/**
 ...
 * @since 4.0.0
 */
export declare const isMulticast: (self: IpAddress) => boolean;
/**
 ...
 * @since 4.0.0
 */
export declare const isBroadcast: (self: Ipv4Address) => boolean;
/**
 ...
 * @since 4.0.0
 */
export declare const isLinkLocal: (self: IpAddress) => boolean;
/**
 ...
 * @since 4.0.0
 */
export declare const isPrivate: (self: Ipv4Address) => boolean;
/**
 ...
 * @since 4.0.0
 */
export declare const isUniqueLocal: (self: Ipv6Address) => boolean;
/**
 ...
 * @since 4.0.0
 */
export declare const toCanonical: (self: IpAddress) => IpAddress;
/**
