 ...
 * @since 4.0.0
 */
export type Answer<D extends Any> = D extends Classify<infer Label> ? ClassifyAnswer<Label> : D extends Rate<infer Level> ? RateAnswer<Level> : D extends Probability ? ProbabilityAnswer : never;
/**
 ...
 * @since 4.0.0
 */
export declare const classify: <Label extends string>(options: {
    readonly instructions: string;
 ...
 * @since 4.0.0
 */
export declare const rate: <const Level extends string>(options: {
    readonly instructions: string;
    readonly criteria: ReadonlyArray<Level>;
}) => Rate<Level>;
/**
 ...
 * @since 4.0.0
 */
export declare const probability: (options: {
    readonly instructions: string;
    readonly criteria: {
        readonly false: string;
        readonly true: string;
 ...
 * @since 4.0.0
 */
export declare const make: <Input extends Schema.Constraint, Decisions extends Record<string, Any>>(options: {
    readonly input: Input;
    readonly decisions: Decisions;
